...
if(isset($_SESSION['duplicates'])) {
  ...
  <div class="row">
    ...
    $query = "SELECT performances.id, artists.name FROM performances INNER JOIN artists ON performances.artistid = artists.id  WHERE DATE(performdate) = CURDATE() AND performances.second = 4";
  ...
  <input type="hidden" name="delfinal" value="<?php echo 4; ?>">     
  <div class="row">
